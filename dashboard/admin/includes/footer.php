<?php
// File: dashboard/admin/includes/footer.php
?>
    </div>
    ...
    <script>
        ...
        const menuToggle = document.getElementById('menuToggle'), sidebar = document.getElementById('adminSidebar'), overlay = document.getElementById('sidebarOverlay');
