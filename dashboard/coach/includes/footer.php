<?php
// File: dashboard/coach/includes/footer.php
?>
    </div>
    ...
    <script>
        ...
        const menuToggle = document.getElementById('menuToggle'), sidebar = document.getElementById('coachSidebar'), overlay = document.getElementById('sidebarOverlay');
