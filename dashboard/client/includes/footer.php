<?php
// File: dashboard/client/includes/footer.php
?>
    </div>
    ...
    <script>
        ...
        const menuToggle = document.getElementById('menuToggle'), sidebar = document.getElementById('clientSidebar'), overlay = document.getElementById('sidebarOverlay');
